...
class BigsnacksScreen extends StatefulWidget {
  const BigsnacksScreen({super.key});

  @override
  State<BigsnacksScreen> createState() => _BigsnacksScreenState();
}

class _BigsnacksScreenState extends State<BigsnacksScreen> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl:8000/?query=과자'));
